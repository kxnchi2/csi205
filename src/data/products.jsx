...
// ตัวแปรภายในไฟล์ — เพื่อเก็บสินค้าที่เพิ่มราคาแล้ว
let productsWithPrice = [];

/**
 * ✅ ฟังก์ชัน fetchProducts()
 * สร้างรายการสินค้าพร้อมราคาสุ่ม (10–100 USD)
 * และ return ข้อมูลเป็น array
 */
export function fetchProducts() {
  if (productsWithPrice.length === 0) {
    productsWithPrice = products.map((product) => {
      ...
      // ✅ กำหนดราคาสุ่มระหว่าง $10 ถึง $100
      newProduct.price = Math.floor(Math.random() * 91) + 10;
      return newProduct;
    });
  }
